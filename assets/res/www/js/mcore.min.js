...
/*! MFile 2.1.4.10 [Android 2.1.4.10, iOS 2.1.4.9] */
...
/*! MDrawing Plugin 2.1.1.14 [Android 2.1.1.14, iOS 2.1.1.8] */
(function(b,c){var a="2.1.1.14";M.plugin("drawing",{create:function(){var e,g,f=b,h={};e=M.defaultSetting.create({paramsKeys:["callback"],defaultSetting:{savePoint:"APPINSIDE",path:"",format:"PNG",privacy:false,orientation:"DEFAULT",userInterfaceType:"DEFAULT",saveSizeIndex:"",callback:function(j,i){}},surrogateKeys:{alias:"path",source:"path",donecb:"callback",uitype:"userInterfaceType",orient:"orientation",orientationType:"orientation",done:"callback",ondone:"callback",onsave:"callback"},enumsKeys:{savepoint:{APPINSIDE:0,APPOUTSIDE:1},format:{PNG:0,JPG:1},userInterfaceType:{DEFAULT:0,BUTTON:1},orientation:{DEFAULT:0,PORT:1,PORTRAIT:1,LAND:2,LANDSCAPE:2,PORTREV:3,"PORT|REVERSE":3,"PORTRAIT|REVERSE":3,LANDREV:4,"LAND|REVERSE":4,"LANDSCAPE|REVERSE":4,ALL:5}}});g=e.convert(arguments);var d=M.response.on(function(j,i){g.callback.call(f,j,i,g)});h.callback=d.toString();h.savePoint=g.savePoint;h.privacy=g.privacy===true?"YES":"NO";h.format=g.format;h.saveSizeIndex=g.saveSizeIndex;h.userInterfaceType=g.userInterfaceType;h.orientation=g.orientation;if(g.path){h.path=g.path}M.execute("wn2PluginDrawingCreate",h);return M},open:function(){var e,g,f=b,h={};e=M.defaultSetting.create({paramsKeys:["callback"],defaultSetting:{savePoint:"APPINSIDE",path:"",format:"PNG",privacy:false,orientation:"DEFAULT",saveSizeIndex:"",userInterfaceType:"DEFAULT",callback:function(j,i){}},surrogateKeys:{alias:"path",source:"path",orient:"orientation",orientationType:"orientation",uitype:"userInterfaceType",donecb:"callback",done:"callback",ondone:"callback",onsave:"callback"},enumsKeys:{savepoint:{APPINSIDE:0,APPOUTSIDE:1},format:{PNG:0,JPG:1},userInterfaceType:{DEFAULT:0,BUTTON:1},orientation:{DEFAULT:0,PORT:1,PORTRAIT:1,LAND:2,LANDSCAPE:2,PORTREV:3,"PORT|REVERSE":3,"PORTRAIT|REVERSE":3,LANDREV:4,"LAND|REVERSE":4,"LANDSCAPE|REVERSE":4,ALL:5}}});g=e.convert(arguments);var d=M.response.on(function(j,i){g.callback.call(f,j,i,g)});h.callback=d.toString();h.savePoint=g.savePoint;h.privacy=g.privacy===true?"YES":"NO";h.format=g.format;h.userInterfaceType=g.userInterfaceType;h.orientation=g.orientation;h.saveSizeIndex=g.saveSizeIndex;if(g.path===""&&M.media){M.media.library({media:"PHOTO",choose:"SINGLE"},function(j,i){if(j==="SUCCESS"){h.path=i.path;setTimeout(function(){M.execute("wn2PluginDrawingOpen",h)},500)}else{d.execute([])}})}else{h.path=g.path;M.execute("wn2PluginDrawingOpen",h)}return M}},a)})(window);

/*! MQr Plugin 2.1.5.9 [Android 2.1.5.9, iOS 2.1.5.9] */
(function(b,c){var a="2.1.5.9";M.plugin("qr",{scan:function(){var e,g,d,f=b,h={};e=M.defaultSetting.create({paramsKeys:["callback","__SETTING__"],defaultSetting:{callback:function(i,j){M.debug.log("M.db.create.callback",i)},flash:false,fadeToggle:false,useGuideLine:false,orientation:"DEFAULT",captureScale:{width:1,height:1},filterType:"NONE",page:""},surrogateKeys:{onscan:"callback",orient:"orientation",orientationType:"orientation",menuanimation:"fadetoggle",crop:"captureScale",scale:"captureScale"},enumsKeys:{orientation:{DEFAULT:0,PORT:1,PORTRAIT:1,LAND:2,LANDSCAPE:2,PORTREV:3,"PORT|REVERSE":3,"PORTRAIT|REVERSE":3,LANDREV:4,"LAND|REVERSE":4,"LANDSCAPE|REVERSE":4,ALL:5},fileterType:{NONE:0,PARTIAL:1,EAN8:8,UPCE:9,ISBN10:10,UPCA:12,EAN13:13,ISBN13:14,I25:25,DATABAR:34,DATABAR_EXP:35,CODABAR:38,CODE39:39,PDF417:57,QRCODE:64,CODE93:93,CODE128:128}}});g=e.convert(arguments,function(i,j,k){if(i=="fadeToggle"){if(typeof k==="string"){if(k==="ON"){return true}else{if(k==="OFF"){return true}}}return j}});g.response=M.response.on(function(i){var j={};if(i.error){j={status:i.status,error:i.error,message:i.error}}else{j={status:i.status,format:i.format||"",text:i.text||"",result:i.text||""}}g.callback.call(f,j,g)});h.callback=g.response.toString();h.orientation=g.orientation;h.isFlashOn=g.flash===true?"Y":"N";h.isFadeToggle=g.fadeToggle===true?"Y":"N";h.useGuideLine=g.useGuideLine===true?"Y":"N";h.captureScale=JSON.stringify(g.captureScale);h.filterType=g.filterType;h.page=g.page;d=M.execute("wn2PluginQrScan",h);if(d.status!=="PROCESSING"){g.response.execute(d)}return M},open:function(){return this.scan.apply(this,arguments)}},a)})(window);

/*! MDocViewer Plugin 2.1.1.3 [Android 2.1.0.5, iOS 2.1.1.3]  */
(function(b,c){var a="2.1.1.3";M.plugin("viewer.doc",{gview:function(){var e,g,d,f=b,h={};e=M.defaultSetting.create({paramsKeys:["url","title","orientation","animation"],defaultSetting:{url:"",title:"",orientation:"DEFAULT",animation:"DEFAULT"},surrogateKeys:{orient:"orientation",orientationtype:"orientation",animate:"animation",animationtype:"animation"},enumsKeys:{orientation:{DEFAULT:0,PORT:1,PORTRAIT:1,LAND:2,LANDSCAPE:2,PORTREV:3,"PORT|REVERSE":3,"PORTRAIT|REVERSE":3,LANDREV:4,"LAND|REVERSE":4,"LANDSCAPE|REVERSE":4,ALL:5},animation:{DEFAULT:0,NONE:1,SLIDE_LEFT:2,SLIDE_RIGHT:3,SLIDE_TOP:4,SLIDE_BOTTOM:5,ZOOM_IN:6,ZOOM_OUT:7,FADE:8,MODAL_UP:9,MODAL_DOWN:10}}});g=e.convert(arguments);if(g.url==""){return{status:"FAIL",message:"fail to open google document viewer. because url is empty."}}h.url=g.url;h.title=g.title;h.orientation=g.orientation;h.animation=g.animation;d=M.execute("wn2PluginViewerDocOpenWithGoogleDocsViewer",h);return d},open:function(){var e,g,d,f=b,h={};e=M.defaultSetting.create({paramsKeys:["path","title","orientation","animation"],defaultSetting:{path:"",title:"",orientation:"DEFAULT",animation:"DEFAULT"},surrogateKeys:{alias:"path",source:"path",url:"path",orient:"orientation",orientationtype:"orientation",animate:"animation",animationtype:"animation"},enumsKeys:{orientation:{DEFAULT:0,PORT:1,PORTRAIT:1,LAND:2,LANDSCAPE:2,PORTREV:3,"PORT|REVERSE":3,"PORTRAIT|REVERSE":3,LANDREV:4,"LAND|REVERSE":4,"LANDSCAPE|REVERSE":4,ALL:5},animation:{DEFAULT:0,NONE:1,SLIDE_LEFT:2,SLIDE_RIGHT:3,SLIDE_TOP:4,SLIDE_BOTTOM:5,ZOOM_IN:6,ZOOM_OUT:7,FADE:8,MODAL_UP:9,MODAL_DOWN:10}}});g=e.convert(arguments);if(g.path==""){return{status:"FAIL",message:"fail to open document viewer. because path is empty."}}h.path=g.path;h.title=g.title;h.orientation=g.orientation;h.animation=g.animation;d=M.execute("wn2PluginViewerDocOpen",h);return d}},a)})(window);
